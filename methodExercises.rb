...
# When having input of an array you dont need to include [] like in java 
...
# Using a **DEFAULT** parameter here 
...
# NOTE --> the ? here shows that the method is going to return a boolean value
